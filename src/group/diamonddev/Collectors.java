...
import group.diamonddev.function.*;
...
public final class Collectors {
     ...
     */
    public static <T> Collector<T, ?, T> reducing(final T identity,
    ...
    private static <T, A1, A2, R1, R2, R> Collector<T, ?, R> teeingImpl(
            final Collector<? super T, A1, R1> downstream1,
        ...
        return new CollectorsImpl<T, Map.Entry<A1, A2>, R>(
                ...
                new BiConsumer<Map.Entry<A1, A2>, T>() {
                    @Override
                    public void accept(Map.Entry<A1, A2> entry, T t) {
    ...
    private static IllegalStateException duplicateKeyException(Object key, Object old, Object value) {
        return new IllegalStateException("Duplicate key " + key + " (attempted merging values " + old + " and " + value + ")");
    }
